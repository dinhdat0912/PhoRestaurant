            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <table class="table table-striped text-center  table-hover">
                        ...
                        <?php 
                            global $ConnectingDB;
                            $sql = "SELECT DISTINCT name,ReservationReference FROM customer 
                                    WHERE NOT EXISTS(SELECT * FROM reservation WHERE customer.ReservationReference=reservation.ReservationReference)";
