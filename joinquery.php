            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <table class="table table-striped text-center  table-hover">
                        ...
                        <?php 
                            global $ConnectingDB;
                            $sql = "SELECT customer.name,reservation.ReservationReference, customer.phonenumber
                            FROM customer
                            INNER JOIN reservation ON customer.ReservationReference=reservation.ReservationReference";
                            $stmt = $ConnectingDB->query($sql);
                            while($dataRows=$stmt->fetch()){
                                $name=$dataRows["name"];
                                $reservation=$dataRows["ReservationReference"];
                                $number=$dataRows["phonenumber"];
                        ?>
